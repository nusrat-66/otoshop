...
function Index() {
  ...
  return (
    <div className='dv-wrapper'>
     ...
     <button onClick={()=>setTypeOfSearch(true)} className={typeOfSearch?"search__switcher search__switcher_active":"search__switcher"}>
     Təkərə görə axtar
     </button>
      <button onClick={()=>setTypeOfSearch(false)} className={!typeOfSearch?"search__switcher search__switcher_active":"search__switcher"}>
     Avtomobilə görə axtar
     </button>
            </div>


    {    typeOfSearch &&    <div className="search__footer_first">
            ...
            {    !typeOfSearch &&   <div className="search__footer_first">
                <div className="search__inputs">
                    <select className='search__select search__select_half' name="" id="">
